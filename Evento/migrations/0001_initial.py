    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_de_equipamentoid', models.ForeignKey(db_column='Tipo de equipamentoID', default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Recurso.tipodeequipamento')),
