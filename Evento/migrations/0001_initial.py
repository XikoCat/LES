    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dia_final', models.DateField(blank=True, db_column='Dia final', null=True)),
                ('hora_final', models.TimeField(blank=True, db_column='Hora final', null=True)),
                ('capacidade', models.IntegerField(blank=True, db_column='Capacidade', default=None, null=True)),
                ('estado', models.CharField(blank=True, db_column='Estado', default='Não submetido', max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(db_column='ID', primary_key=True, serialize=False)),
                ('eventoId', models.ForeignKey(db_column='Evento', null=True, on_delete=django.db.models.deletion.SET_NULL, to='Evento.evento', verbose_name='Evento')),
                ('servicoId', models.ForeignKey(db_column='Servico', null=True, on_delete=django.db.models.deletion.SET_NULL, to='Recurso.serviço', verbose_name='serviço')),
            ],
        ),
        migrations.CreateModel(
            name='EventoLocais',
            fields=[
                ('id', models.AutoField(db_column='ID', primary_key=True, serialize=False)),
                ('eventoId', models.ForeignKey(db_column='Evento', null=True, on_delete=django.db.models.deletion.SET_NULL, to='Evento.evento', verbose_name='Evento')),
                ('localId', models.ForeignKey(db_column='Local', null=True, on_delete=django.db.models.deletion.SET_NULL, to='Recurso.sala', verbose_name='Sala')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(db_column='ID', primary_key=True, serialize=False)),
                ('equipamentoId', models.ForeignKey(db_column='Equipamento', null=True, on_delete=django.db.models.deletion.SET_NULL, to='Recurso.equipamento', verbose_name='equipamento')),
                ('eventoId', models.ForeignKey(db_column='Evento', null=True, on_delete=django.db.models.deletion.SET_NULL, to='Evento.evento', verbose_name='Evento')),
            ],
        ),
    ]
