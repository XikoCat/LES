...
class Evento(models.Model):
    ...
    local = models.IntegerField(db_column='Local', blank=True, null=True) 
...
class PedidoDeRecurso(models.Model):
    ...
    tipo_de_equipamentoid = models.ForeignKey('Recurso.TipoDeEquipamento', models.SET_NULL, default=None, null=True, db_column='Tipo de equipamentoID') 
    tipo_de_serviçoid = models.ForeignKey('Recurso.TipoDeServiço', models.SET_NULL, default=None, null=True, db_column='Tipo de serviçoID') 
