    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_de_eventoid', models.ForeignKey(blank=True, db_column='Tipo de eventoID', default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Evento.tipodeevento')),
            ],
            options={
                'db_table': 'Formulário',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(db_column='ID', primary_key=True, serialize=False)),
                ('pos', models.IntegerField(db_column='Pos', default=None, null=True, verbose_name=django.db.models.deletion.SET_NULL)),
                ('formulárioid', models.OneToOneField(db_column='FormulárioID', on_delete=django.db.models.deletion.CASCADE, to='Formulario.formulário')),
                ('perguntaid', models.OneToOneField(db_column='PerguntaID', on_delete=django.db.models.deletion.CASCADE, to='Formulario.pergunta')),
            ],
            options={
